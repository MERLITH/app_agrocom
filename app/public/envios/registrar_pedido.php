<?php include_once('assets/home/home_arriba.php');?>
    ...
    <div id="main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form name="save" id="save">
                            <div class="row" data-contenedor="row_1" style="display: none;">
                                <div class="col-md-12">
                            ...
                            <div class="row" data-contenedor="row_2" >
                                <div class="col-md-12">
                                    <h4 class="card-title">1. Completa tus datos</h4>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="label-control" for="empresa_remitente">Nombres</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row" data-contenedor="row_3" style="display: none;">
                                <div class="col-md-12">
                            ...
                            <div class="row" data-contenedor="row_4" >
                                <div class="col-md-12">
                                    <h4 class="card-title">2. Elige tu tela</h4>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12" style="text-align: right;">
                                    <div class="form-group">
                                        <label style="font-weight: bold;">TOTAL CANTIDAD: &nbsp;<span name="total-bultos">0.00</span></label><br>
                                        <label style="font-weight: bold;">TOTAL IMPORTE: S/&nbsp;<span name="total-importe">0.00</span></label>
                                    </div>
                                </div>
                            ...
                            <div class="row" data-contenedor="row_5" >
                                <div class="col-md-12">
                                    <h4 class="card-title">3. ¿Cuál es el destino de tu pedido?</h4>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="label-control" for="direccion_destinatario">Dirección completa</label>
                                    </div>
                                </div>
                            ...
                            <div class="row" data-contenedor="row_6" style="display: none;">
                                <div class="col-md-12">
                            ...
                            <div class="row" data-contenedor="row_7">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" name="submit" class="form-control-submit-button">CONTINUAR</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">Agregar telas</h4>
                    ...
                    <div class="modal-body">
                        <form id="modal-item-form">
                            ...
                            <div class="container mt-3 mb-3" style="max-height: calc(100vh - 210px); overflow-y: auto;">
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="card p-3 mb-2" style="border-radius: 15px">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="badge"> <span class="badge badge-secondary">Color</span> </div>
                                            </div>
                                            <div class="mt-3">
                                                <h5 class="heading text-center">PRODUCTO</h5>
                                                <div class="mt-2">
                                                    <span class="badge badge-light" style="width: 100%;"><h5>S/ 0.00</h5></span>
                                                    <div class="mt-2 text-center"> <button style="border-radius: 15px" type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar</button> </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- MODAL VALIDAR -->
        <div class="modal inmodal fade" name="modal-validar_cliente" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">Validación de identificación</h4>
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>    
                    </div> 
                        <div class="modal-body">
                            <form id="validar_cliente" name="validar_cliente">
                                <input type="hidden" class="form-control" name="id_cliente"/>
                                <input type="hidden" class="form-control" name="razon_social_cliente"/>
                                <input type="hidden" class="form-control" name="email_cliente"/>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="font-weight: bold">El nombre o apellido ingresado debe ser igual al registrado<span class="text-danger"> </span></label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="nombre" placeholder="Ingresar nombre o apellido" autocomplete="off" title=""/>
                                            </div>                              
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer" align="center" style="display:block" >
                            <button type="button" name="validar_cliente" class="btn btn-primary">Comprobar</button>
                        </div>
                </div>
            </div>
        </div>
                ...
                else
                {
                    ...
                    jQuery.ajax({
                        ...
                        success: function(response)
                        {
                            ...
                            window.location = "confirmar_datos.php?id="+response.id_orden_envio;  
