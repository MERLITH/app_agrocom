 ...
 let Componente = {
     render: async (d, data, id_categoria) => {
        ...
        <div id="main">
         ...
         await Componente.after_render(id_categoria);       
         
    },
 
     after_render: async (id_categoria) => {

         DOM_ID = '#main';
         DOM = $(DOM_ID);

         Componente.id_categoria = id_categoria;
    ...
    listado_productos: async (id_producto = null, texto_buscar = '') => {

         let html = '';
         let id_contenedor = '#div_listado_productos';
         let id_usuario = GLOBAL.usuario ? GLOBAL.usuario.id: 0;
         let oData = {id_usuario : id_usuario, texto_buscar : texto_buscar, id_categoria : Componente.id_categoria};
     ...
     get_categoria: async () => {
         ...
         let data_resp = await $.fetchData('get', 'publico/productos/get_categoria/'+Componente.id_categoria, {});

         if (data_resp) {     
            DOM.find('.nombre_categoria').text(data_resp.nombre);
         } 
