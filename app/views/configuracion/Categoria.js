...
let Componente = {
                            ...
                            <div class="modal-body">
                                <div class="row"> 
                                    ...
                                    <div class="col-md-12 text-center">
                                        <label class="form-label">Incluir en utilidad?</label>
                                        <div class="form-check">
                                            <label class="toggleSwitch">
                                                <input type="checkbox" name="fl_incluir_utilidad"/>
                                                <span>
                                                    <span>NO</span>
                                                    <span>SI</span>
                                                </span>
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:BASE_API + 'configuracion/categoria',
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
                ...
                { title: 'INCLUYE EN UTILIDAD?', render: function(data, type, row){ 

                    let html = '<span class="label label-default">NO</span>'
                    
                    if(row.fl_incluir_utilidad == 1)
                    {
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nueva Categoría');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Categoría');
        ...
        if (data.fl_incluir_utilidad == 1) {

            form.find('input[name="fl_incluir_utilidad"]').prop('checked', true);
            
        }else{

            form.find('input[name="fl_incluir_utilidad"]').prop('checked', false);
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Categoría');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'configuracion/categoria/' + this.action_submit,
            data: formData
        })
