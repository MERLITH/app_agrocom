...
let Componente = {
                                ...
                                <div class="row">     
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre" class="form-control" autocomplete="off" list="tipo-tipo_documento">
                                            <datalist id="list-tipo_documento"></datalist>
                                        </div>
                                    </div>                                    
                                </div>                              
                            </div>
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:BASE_API + 'configuracion/tipo_documento',
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nueva Tipo Documento');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Tipo Documento');
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Tipo Documento');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'configuracion/tipo_documento/' + this.action_submit,
            data: formData
        })
