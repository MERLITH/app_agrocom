...
let Componente = {
                                ...
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre" class="form-control" autocomplete="off" placeholder="BULTOS">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">Código SUNAT </label>
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:BASE_API + 'configuracion/unidad_medida',
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
