...
let Componente = {
                ...
                <div class="col-md-8">
                    <h4 class="fw-bold py-0 mb-4">
                        ...
                        <small>
                            ...
                            <a href="javascript:" class="icon-home text-primary">Almacen</a>&nbsp;
                        </small>
                    </h4>
                </div>
    ...
    datatable: async function() {
        ...
        var oData = await $.getData('logistica/almacen');
        ...
        var oColums = [
            ...
            { "data": "descripcion", "title": "DESCRIPCIÓN", "class": "text-left", ordenable: true },
            {
            ...
            <form name="save" id="formSave">
                <div class="row mt-2">
                    ...
                    <div class="col-12">
                        ...
                        <textarea rows="3" name="descripcion" class="form-control" autocomplete="off"></textarea>
                    </div>
                </div>
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'logistica/almacen/' + this.action_submit,
            data: formData
        })
