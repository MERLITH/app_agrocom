 ...
 let Componente = {
         ...
         <div id="main">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4 text-end">
                    ...
                    <button type="button" class="btn rounded-pill btn-info waves-effect waves-light" name="nuevo_orden">
                        <span class="tf-icons mdi mdi-plus-circle-outline me-1"></span>
                        Nuevo desde Orden
                    </button>
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select" data-select="COMPROBANTE" name="id_comprobante"></select>                  
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="id_moneda" data-select="MONEDA" class="form-select"></select>                         
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="origen_pago" class="form-select">
                                                                <option value="">Seleccione...</option>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pagado_por" class="form-select">
                                                                <option value="">Seleccione...</option>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select type="text" class="form-select" name="id_proveedor" data-select="PROVEEDOR"/></select>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="modal animate__animated animate__bounceInDown" name="modal-nuevo_orden" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" aria-modal="true"
                role="dialog">
                <div class="modal-dialog modal-dialog-centered  modal-lg">
                    <div class="modal-content p-0">
                        <div class="modal-header  bg-label-primary pt-2 pb-2">
                            <p class="modal-title fw-semibold fs-5" name="nuevo_orden">Nuevo desde Orden de Compra</p>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body p-3">
                            <div class="custom-option custom-option-icon checked p-2">
     ...
     after_render: async () => {
        ...
        DOM.find('input[name="fecha_fin"]').val(HELPER.fecha_actual());
         ...
         await Componente.select_comprobante();
     ...
     new: () => {
        ...
        DOM.find('p[name="'+accion+'"]').html('<i class="mdi mdi-check-circle me-1"></i> Nueva compra');
     ...
     edit: async (data) => {
        ...
        DOM.find('p[name="'+accion+'"]').html('<i class="mdi mdi-check-circle me-1"></i> Editar compra');

         await axios.get(BASE_API+'logistica/compra/get_unique/'+data.id)
         .then( async (response) => {            
            data = response.data;
     ...
     get_orden_compra: async (id_orden_compra = null) => {
        ...
        if(id_orden_compra != null && id_orden_compra != '')
        {
            ...
            await axios.get(BASE_API+'logistica/orden_compra/get_unique/'+id_orden_compra)
            .then( async (response) => {            
    ...
    select_moneda: async () =>
    {
     ...
     {
        var url = "logistica/orden_compra/get_select_pendiente";
        var idcombo = DOM.find('select[data-select="ORDEN_COMPRA"]');
        await $.select_render(url, idcombo);
     },

     select_comprobante: async () =>
     {
        var url = "recursos/data_static/comprobante";
        var idcombo = DOM.find('select[data-select="COMPROBANTE"]');
        await $.select_render(url, idcombo);
     },
    ...
    datatable: async function() {
        ...
        var oData = await $.getData('logistica/compra?'+jQuery.param(parametros));
        ...
        var oColums = [
            ...
            { "title": 'CONDICIÓN PAGO', "data": 'condicion_pago' },
            { "title": 'ORIGEN PAGO', "data": 'origen_pago' },
            { "title": 'PAGADO POR', "data": 'pagado_por' },
            { "title": 'VENCIMIENTO', "data": null, render: function(data, type, row) { 
                    
                if(row.condicion_pago == 'CREDITO')
                {
                    if(row.dias_restantes <= 0)
                    {
                        return `<span class="badge rounded-pill bg-danger">Hace `+row.dias_restantes+` dias</span>`; 
                    }
                    else
                    {
                        return `<span class="badge rounded-pill bg-primary">En `+row.dias_restantes+` dias</span>`; 
                    }
                }
                else
                {
            ...
            { "title": 'ORDEN DE COMPRA', "data": 'orden_compra' },
                ...
                render:
                    function (data, type, row) {
                        ...
                        arrayMasButton.push(
                            ...
                            {
                                element: "a",
                                properties: {class: "dropdown-item btnImprimirQR",href: "javascript:;",html: '<span class="mdi mdi-printer-outline"></span> Imprimir QR'},
                            },
                            {
                                element: "a",
        ...
        $('.tblRegistros tbody').on('click', '.btnImprimirQR', function () {
            var oTrRow = $(this).parent().parent().parent();
            var oDataRow = datableTarea.row(oTrRow).data();
            Impresion.qr(oDataRow.id);     
        });
    ...
    submit: function() {
        ...
        else
        {
            ...
            axios({
                method: 'post',
                url: BASE_API + 'logistica/compra/'+Componente.action_submit,
                data: formData
            })
            .then(function(response) { 
