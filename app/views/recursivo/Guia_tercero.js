...
let Componente = {
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody name="detalle-guia_tercero"></tbody>
                    <tfoot>
                        <tr>
                            <td><button type="button" name="agregar_guia_tercero" class="btn btn-secondary"><i class="fa fa-plus"></i> Agregar</button></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    after_render: async (d = 'main') => {
        ...
        /* AGREGAR */
         DOM.find('button[name="agregar_guia_tercero"]').click(function(e) {
            e.stopImmediatePropagation();
            Componente.agregar();
        });

        /* QUITAR  */
        DOM.on('click', 'button[name="quitar-guia_tercero"]', function(e) {
            e.stopImmediatePropagation();
            Componente.quitar($(this));
        });


        DOM.find('tbody[name="detalle-guia_tercero"]').html('');
    ...
    agregar: (data = null) => {
        ...
        let html = `
            <tr data-codigo="`+codigo+`">
                ...
                <td><button type="button" name="quitar-guia_tercero" class="btn btn-danger"><i class="fa fa-times"></i></button></td>
            </tr>
        `;

        DOM.find('tbody[name="detalle-guia_tercero"]').append(html);
    },
    ...
    get_datajson: () => {
        ...
        DOM.find('tbody[name="detalle-guia_tercero"] tr').each(function(){
