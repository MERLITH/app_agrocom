 ...
 */
 ...
 let Componente = {
     ...
     print: async (id) => {
         ...
         await axios.get(BASE_API + 'envio/proforma_envio/imprimir/'+id)
                ...
                <table  style="width:100%; border-collapse:collapse;">
                    <!-- <tr>
                        <td style="width:30%; background-color:#fce4d6; border-collapse:collapse;">
                            ...
                            <img src="`+BASE_FILES+`images/logo_cargo_express.png" style="max-height:70px;" width="250px"/>
                        </td>
                    ...
                    <tr>
                        <td style="width:24%;">
                            <img src="assets/images/logo_cargo_express.png"style="width:100%;"/>
                                ...
                                <tfoot>
                                                ...
                                                <table style="width:100%; border-collapse:collapse;">
                                                    <tr>
                                                        <td style="font-weight:bold; font-size:11px !important; border-collapse:collapse;" align="left">
                                                            ...
                                                            <div><strong>IGV <span id="fact-igv_porcenataje"></span>:</strong></div>
                                    ...
                                    <tr>
                                        <td colspan="4" align="right">
                                            <strong>IMPORTE EN LETRAS: </strong> `+Numero_letra.convertir(data.total_importe,'SOLES')+`
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
