          ...
          <tr>
            <td style="vertical-align: middle; padding-bottom: 20px;">
              ...
              <table class="table-full" border="0" align="center" cellpadding="0" cellspacing="0">
                <tbody>
                  <tr>
                    <td align="center" style="line-height: 0px;vertical-align: middle;"><img label="image" src="<?= $_ENV['BASE_URL_FRONTEND']; ?>assets/images/logo_login3.png" alt="img" width="60" style="display:block; line-height:0px; font-size:0px; border:0px;" mc:edit="switch-1"></td>
                  </tr>
                </tbody>
              </table>
  ...
  <tbody><tr>
    <td align="center">
      ...
      <table class="table-inner ui-resizable" width="600" style="max-width: 600px;" border="0" align="center" cellpadding="0" cellspacing="0">
        <tbody>
          <tr>
            <td align="center" style="line-height: 0px;vertical-align: middle;"><img label="image" src="<?= $_ENV['BASE_URL_FRONTEND']; ?>assets/images/sin_dinero.png"  width="350" alt="img" style="display:block; line-height:0px; font-size:0px; border:0px;" mc:edit="switch-1"></td>
          </tr>
        </tbody>
      </table>
          ...
          <tbody>
            ...
            <tr>
              <td mc:edit="switch-58" align="left" style="font-family:'Open Sans', Arial, 'sans-serif'; font-size: 14px;color: #122333; line-height: 28px;">
                <div><span style="font-size: 20px;">Alerta, se necesita un reembolso debido a que el siguiente conductor se excedió en sus gastos que se le otorgó del BANCO-LIMA: <?= $data->agencia.' | S/ '.$data->importe_agencia; ?>.</span></div><br>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="text-align: center;border: 1px solid #D4102F; border-width: 0px 1px 1px 0px;border-radius: 0px 0px 10px 0px;">
                        <small style="background-color: rgba(250,92,124,.25)!important; color: rgb(250,92,124); padding: 5px; border-radius: 6px;">EXCEDIDO</small>
                      </td>
                    </tr>
                  </tbody>
